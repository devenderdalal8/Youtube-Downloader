...
object Constant {
    ...
    const val DOWNLOAD_START = "Please wait for start downloading..."
    const val TRY_AGAIN = "Please try again"
    const val CLICK_TO_WATCH = "Please click to watch"
    const val VIDEO_NOTIFICATION_ID = "video_notification_id"
